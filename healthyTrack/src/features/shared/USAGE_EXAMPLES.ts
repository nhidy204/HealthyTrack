...
import { formatDateLong, toISODateString } from '@shared/utils/date';
...
import { basicInfoSchema, goalsSchema } from '@onboarding/onboarding.schema';
import type { BasicInfoFormData, GoalsFormData } from '@onboarding/onboarding.schema';
...
/*
import { formatDateShort, getDayName, addDays, formatCalories } from '@shared/utils/date';
...
3. Import date utilities from '@shared/utils/date'
